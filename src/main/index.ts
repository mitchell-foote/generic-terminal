...
app.whenReady().then(() => {
  ...
  electronApp.setAppUserModelId('com.foote.genericterminal')
  ...
  app.on('browser-window-created', (_, window) => {
    ...
    globalShortcut.register('CommandOrControl+Alt+K', function () {
      const focused = BrowserWindow.getFocusedWindow()
      focused && focused.webContents.closeDevTools()
      if (focused && focused.isKiosk()) {
        focused.setKiosk(false)
      } else if (focused) {
        focused.setKiosk(true)
      }
    })
